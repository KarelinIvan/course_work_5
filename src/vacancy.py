...
class Vacancy:
    """
    Класс для работы с вакансиями компаний
    """
    __slots__ = (
    ...
    def __init__(self, name, alternate_url, salary_from, salary_to,
                 salary_currency, employer_id, area_name, requirement, responsibility):
        """
        Конструктор класса
        """
        self.name: str = name
    ...
    def __str__(self) -> str:
        """
        Представление вакансий ввиде строки
        """
    ...
    def from_vacancy_cls(cls, vacancy_date: dict ) -> Any:
        ...
        """
        if isinstance(vacancy_date, dict):
            salary = vacancy_date.get("salary", {})
